...
namespace ITSolution.Framework.Server.ReportServer
{
    [ITSolutionServer(typeof(ReportController))]
    public partial class ReportController : DefaultServer<ReportController>, IReportServer
    {
        ...
        public ReportController(IContainer container)
        {
            container.Add(this);
